...
public class Druide {
	...
	public void preparerPotion() {
	    ...
	    int range = effetPotionMax - effetPotionMin + 1;
	    int forcePotion = random.nextInt(range) + effetPotionMin;

	    parler("J'ai préparé une potion de force " + forcePotion);
    ...
    public void booster(Gaulois gaulois) {
        if (gaulois.getNom().equalsIgnoreCase("Obélix")) {
            ...
            parler("Voilà une bonne potion pour toi, " + gaulois.getNom() + " !");
        }
    }
